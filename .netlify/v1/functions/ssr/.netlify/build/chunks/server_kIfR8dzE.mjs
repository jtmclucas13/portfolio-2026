import { _ as ActionNotFoundError, g as ActionCalledFromServerError, p as removeTrailingForwardSlash, pt as AstroError, t as appendForwardSlash, v as ActionsReturnedInvalidDataError } from "./path_TPyXO9Vx.mjs";
import { i as REDIRECT_STATUS_CODES, u as pipelineSymbol } from "./constants_DCZzRVRk.mjs";
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SSR": true
		}, { _: "/Users/joshuamclucas/Projects/portfolio-2026/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": "https://www.joshuamclucas.com",
			"SSR": true
		}, { _: "/Users/joshuamclucas/Projects/portfolio-2026/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
//#endregion
export { BodySizeLimitError as a, createActionsProxy as c, getActionQueryString as d, serializeActionResult as i, createGetActionPath as l, defineAction as n, readBodyWithLimit as o, getActionContext as r, shouldAppendForwardSlash as s, ACTION_API_CONTEXT_SYMBOL as t, deserializeActionResult as u };
