import { C as ExpectedImage, E as FailedToFetchRemoteImageDimensions, G as MissingImageDimension, J as NoImageMetadata, P as IncompatibleDescriptorOptions, R as InvalidImageService, T as ExpectedNotESMImage, c as isRemotePath, dt as UnsupportedImageFormat, f as removeQueryString, l as joinPaths, nt as RemoteImageNotAllowed, pt as AstroError, ut as UnsupportedImageConversion, w as ExpectedImageOptions, z as LocalImageUsedWrongly } from "./path_TPyXO9Vx.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service_CN-p7JhI.mjs").catch((e) => {
